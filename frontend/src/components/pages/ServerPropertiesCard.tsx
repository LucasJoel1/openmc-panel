            ...
            <CardContent className="space-y-2 grid grid-cols-2">
                <div>
                    <div>
                        ...
                        <p className="font-medium">{String(props.data.GameMode).charAt(0).toUpperCase() + String(props.data.GameMode).slice(1)}</p>
                    </div>
                    <div>
                ...
                <div>
                    <div>
                        ...
                        <p className="font-medium">{String(props.data.Difficulty).charAt(0).toUpperCase() + String(props.data.Difficulty).slice(1)}</p>
                    </div>
                    <div>
                        <p className="text-sm text-muted-foreground">Modloader</p>
                        <span className="font-medium">{String(props.data.ModLoader)} </span>
                        <span className="text-muted-foreground">{String(props.data.ModLoaderVersion)}</span>
                    </div>
                </div>
            </CardContent>
        </Card>
